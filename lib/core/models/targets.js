...
const makehuman = require("makehuman-js/src/js/human");
const THREE = require("three");
class Targets extends makehuman.Targets {
    constructor(human) {
        super();
        this.human = human;
    ...
    applyTargets() {
        ...
        if ((new Date().getTime() - this.lastBake) < this.human.minUpdateInterval) {
            return false;
        }
